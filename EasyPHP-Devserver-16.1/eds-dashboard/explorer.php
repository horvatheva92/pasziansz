...
<html lang="en">
	...
	<body style="background-color:transparent;">
		...
		if (is_dir($dir)) {
			...
			echo '<div style="padding:10px 50px 0px 50px;">';
			if ($root_dir != $dir) {
				?>
				<div style="padding:0px 0px 5px 10px;">
				<i style="color:#2980b9;">Folders & files</i><br />
				...
				?>
				<div style="padding:0px 0px 5px 10px;">
				<i class="small" style="color:#2980b9;">Folders & files</i>
				</div>
				<?php
			}	
			...
			<table class="table table-hover table-condensed" style="border:none;">
			<tbody>
			<?php
			$nd = 0;
			...
			foreach($list_file AS $filename) {
				...
				$browse = (in_array(pathinfo($filename, PATHINFO_EXTENSION), $extensions)) ? '<a href="http://127.0.0.1:' . $conf_httpserver['httpserver_port'] . $alias_name . '/' . str_replace('\\', '/', str_replace($root_dir, '', $dir)) . $filename . '" target="_blank"  data-toggle="tooltip" data-placement="top" title="Open in Browser"><span class="glyphicon glyphicon-eye-open small" style="color:#27ae60;" aria-hidden="true"></span></a>' : '';
				?>
				<tr class="small">
					<td style="border-top:none;padding-left:10px;"><i class="fa fa-file" style="color:silver;"></i></td>
					<td style="border-top:none;color:#555555;width:95%;"><?php echo $filename . ' ' . $browse ?></td>
					<td style="border-top:none;padding-right:10px;">
