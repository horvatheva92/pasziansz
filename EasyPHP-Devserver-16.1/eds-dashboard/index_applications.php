		...
		<div class="col-sm-3">
			...
			<div class="list-group">
				...
				<div type="button" class="list-group-item">
					...
					<div class="collapse <?php echo ((isset($_GET['phpfolder']) AND ($_GET['page'] !== ''))) ? 'in' : '' ; ?>" id="php_list">
						<?php
				...
				<div type="button" class="list-group-item">
					...
					<div class="collapse <?php echo ((isset($_GET['page']) AND ($_GET['page'] == 'httpserver'))) ? 'in' : '' ; ?>" id="http_list">
						...
						foreach ($http_servers_list AS $app_params) {
							...
							echo '<div>&#9642; <a href="index.php?zone=applications&page=httpserver&serverfolder=' . $app_params['app_folder'] . '" class="menu_link" data-toggle="tooltip" data-placement="right" title="' . $app_params['app_tag'] . '"><small>' . $httpserver_name . '</small></a></div>';
						}
						?>
						<div>&#9642; <a href="http://warehouse.easyphp.org" target="_blank" class="menu_link" data-toggle="tooltip" data-placement="right" title="Add a version"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></a></div>			
					</div>				 
				...
				<div type="button" class="list-group-item">
					...
					<div class="collapse <?php echo ((isset($_GET['page']) AND ($_GET['page'] == 'dbserver'))) ? 'in' : '' ; ?>" id="db_list">
						...
						foreach ($db_servers_list AS $app_params) {
							...
							echo '<div>&#9642; <a href="index.php?zone=applications&page=dbserver&serverfolder=' . $app_params['app_folder'] . '" class="menu_link" data-toggle="tooltip" data-placement="right" title="' . $app_params['app_tag'] . '"><small>' . $httpserver_name . '</small></a></div>';
						}
						?>	
						<div>&#9642; <a href="http://warehouse.easyphp.org" target="_blank" class="menu_link" data-toggle="tooltip" data-placement="right" title="Add a version"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></a></div>						
					</div>				 
			...
			?>
				...
				<div class="row text-center">
					<div class="col-sm-2 col-sm-offset-1 update_apps">
						<h4>PHP</h4>
						<div style="margin-top:-20px;"><i class="devicon-php-plain" style="font-size:100px;color:#d4d4d4;"></i></div>
					...
					<div class="col-sm-2 update_apps">
						...
						<p class="update_popover" style="padding-top:20px"><a role="button" tabindex="0" style="cursor:pointer;" class="btn btn-default btn-xs" aria-hidden="true" data-toggle="popover" data-placement="top" data-trigger="focus" data-html="true" data-content="<?php echo $update_message ?>"><span class="glyphicon glyphicon-save"></span> update</a></p>
					</div>
					<div class="col-sm-2 update_apps">
						<h4>Ruby</h4>
						<i class="devicon-ruby-plain" style="font-size:50px;color:#d4d4d4;"></i>
						<p class="update_popover" style="padding-top:30px"><a role="button" tabindex="0" style="cursor:pointer;" class="btn btn-default btn-xs" aria-hidden="true" data-toggle="popover" data-placement="top" data-trigger="focus" data-html="true" data-content="<?php echo $update_message ?>"><span class="glyphicon glyphicon-save"></span> update</a></p>
					</div>
					<div class="col-sm-2 update_apps">
						<h4>Perl</h4>
						<samp style="font-size:30px;color:#d4d4d4;">Perl</samp>
						<p class="update_popover" style="padding-top:40px"><a role="button" tabindex="0" style="cursor:pointer;" class="btn btn-default btn-xs" aria-hidden="true" data-toggle="popover" data-placement="top" data-trigger="focus" data-html="true" data-content="<?php echo $update_message ?>"><span class="glyphicon glyphicon-save"></span> update</a></p>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<form method="post" action="http://<?php echo $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ?>" role="form" style="padding-left:20px;">
							<div class="checkbox">
							<label><input type="checkbox" name="autohttpserver" value="1" <?php echo ($edsini['Autostart_httpserver'] == '1')?checked:''; ?> /> start Http server on start-up</label><br />
							<label><input type="checkbox" name="autodbserver" value="1" <?php echo ($edsini['Autostart_dbserver'] == '1')?checked:''; ?> /> start Database server on start-up</label>
							</div>
							...
							<button type="submit" class="btn btn-primary btn-sm" onclick="delay()">save</button>
						</form>
