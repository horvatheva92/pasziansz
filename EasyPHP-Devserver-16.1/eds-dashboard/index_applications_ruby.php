...
<div class="row">
	<div class="col-sm-12">
		...
		<div style="margin:10px 0px 0px 34px;">
			<a href="http://www.easyphp.org" target="_blank" class="menu_link" data-toggle="tooltip" data-placement="right" title="Add a version"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></a>
		</div>
	</div>
</div>
