...
$module_info = array(
	...
	"en"	=>	array(
		"Application"	=>	array(
				"Installation date"	=>	"2016-11-21 16:55:39",
		...
		"How to uninstall this module ?"	=>	array(
				"If you want to uninstall this module, you just have to<br />delete the folder"	=>	"<br />[modules folder]\\phpmyadmin4551x161121165539",
		),	
	),
	"fr"	=>	array(
		"Application"	=>	array(
				"Date d'installation"	=>	"2016-11-21 16:55:39",
				"Site web"	=>	"<a href='http://www.phpmyadmin.net/' target='_blank'>www.phpmyadmin.net</a>"
		),
		"Comment d&eacute;sinstaller ce module ?"	=>	array(
				"Si vous voulez d&eacute;sinstaller ce module, il suffit de supprimer le r&eacute;pertoire"	=>	"<br />[modules folder]\\phpmyadmin4551x161121165539",
		),
	),	
);
